...
from torchtune.modules.attention_utils import _MaskType, _SUPPORTS_FLEX_ATTENTION


# If flex attention is supported, use a flex attention mask instead
if _SUPPORTS_FLEX_ATTENTION:
    from torch.nn.attention.flex_attention import create_block_mask
    from torchtune.modules.attention_utils import causal_mask_flex
